...
def _copy_xcharts_docs(xchartsPath, websitePath, prefixPath, lang):
    ...
    print("srcReadmePath", srcReadmePath)
    print("dstReadmePath", dstReadmePath)
...
if __name__ == "__main__":
    ...
    version = sys.argv[4]
    print("xchartsPath", xchartsPath, os.path.exists(xchartsPath))
    print("websitePath", websitePath, os.path.exists(websitePath))
    print("demoPath", demoPath, os.path.exists(demoPath))
